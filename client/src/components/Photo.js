...
class Photo extends Component {
    ...
    componentDidMount() {
      window.dataLayer.push({
        'event': 'photoView',
        'photo': this.props.photo.TitAccessionNo
      });
    }
                ...
                <div style={{ flex: 1, backgroundColor: 'white' }}>
                    <div style={styles.photoContainer}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start'}}>
                            <span className="touchTarget returnToSearchResults" style={{...globalStyles.body, ...styles.backButton}} onClick={() => { this.props.closePhoto() }}>
                            ...
                            <div style={styles.emailContainer}>
                                ...
                                >
                                    <input 
                                        ...
                                        required
                                    />
                                    <button className="touchTarget sharePhoto" type="submit" form="photoform" style={{ ...styles.emailButton }}>
