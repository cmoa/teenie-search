            ...
            <div style={{ ...styles.largeAlert}}>
              ...
              >
                  ...
                  <div style={{ display: 'flex', flexDirection: 'row', marginLeft: 'auto', alignItems: 'center'}}>
                    <div className="touchTarget" style={{ ...styles.cancelButton, ...globalStyles.body, color: globalStyles.cmoaRed }} onClick={() => this.props.dismissEmailAlert()}>
                      Cancel
                    </div> 
                    <button className="touchTarget" type="submit" form="messageform" style={{ ...styles.emailButton }}>
